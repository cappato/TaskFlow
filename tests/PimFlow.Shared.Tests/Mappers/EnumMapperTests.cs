...
public class EnumMapperTests
{
    ...
    {
        // Act
        var result = EnumMapper.ToShared(domainType);
    ...
    {
        // Act
        var result = EnumMapper.ToDomain(sharedType);
    ...
    {
        // Act
        var result = EnumMapper.ParseArticleTypeToDomain(value);
    ...
    {
        // Act
        var result = EnumMapper.ParseAttributeTypeToDomain(value);
    ...
    public void GetArticleTypeDisplayName_ShouldReturnCorrectDisplayName()
    {
        ...
        // Act
        var result = EnumMapper.GetArticleTypeDisplayName(domainType);
    ...
    public void GetAttributeTypeDisplayName_ShouldReturnCorrectDisplayName()
    {
        ...
        // Act
        var result = EnumMapper.GetAttributeTypeDisplayName(domainType);
    ...
    public void ArticleType_RoundTripConversion_ShouldPreserveValue()
    {
        ...
        // Act
        var sharedType = EnumMapper.ToShared(originalDomainType);
        var backToDomainType = EnumMapper.ToDomain(sharedType);
